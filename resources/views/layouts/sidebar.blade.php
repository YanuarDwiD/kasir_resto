            ...
            <ul class="app-menu list-unstyled accordion">
                ...
                <li class="nav-item has-submenu">
                    ...
                    <div id="submenu-3" class="submenu submenu-3 {{ Request::is('user') ? 'collapse show' : (Request::is('user/create') ? 'collapse show' : 'collapse') }}" data-bs-parent="#menu-accordion">
                        <ul class="submenu-list list-unstyled">
                            <li class="submenu-item"><a class="submenu-link {{ Request::is('user') ? 'active' :  ''}}" href="/user">List Admin</a></li>
                            <li class="submenu-item"><a class="submenu-link {{ Request::is('user/create') ? 'active' :  ''}}" href="/user/create">Tambah Admin</a></li>
                        </ul>
                    </div>
                </li>
                @endcan
                ...
                <li class="nav-item has-submenu">
                    ...
                    <div id="submenu-2" class="collapse submenu submenu-2 {{ Request::is('transaction') ? 'collapse show' : (Request::is('transaction/create') ? 'collapse show' : 'collapse') }}" data-bs-parent="#menu-accordion">
                        <ul class="submenu-list list-unstyled">
                            @can('manager')
                            <li class="submenu-item"><a class="submenu-link {{ Request::is('transaction') ? 'active' :  ''}}" href="/transaction">All Transaksi</a></li>
                            @endcan
                            @can('cashier')
                            <li class="submenu-item"><a class="submenu-link {{ Request::is('transaction') ? 'active' :  ''}}" href="/transaction">All Transaksi</a></li>
                            <li class="submenu-item"><a class="submenu-link {{ Request::is('transaction/create') ? 'active' :  ''}}" href="/transaction/create">Pesanan</a></li>
                            @endcan
                        </ul>
                    </div>
                </li>
