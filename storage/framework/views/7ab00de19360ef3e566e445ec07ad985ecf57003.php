        ...
        <div class="col-lg-5 col-md-12 col-6 mb-4 shadow rounded">
            <div class="card">
                <div class="card-body">
                    ...
                    <span class="fw-semibold d-block mb-1 text-dark">Terbayar</span>
                    <small class="text-success fw-semibold"><i class="bx bx-up-arrow-alt"></i><?php echo e($total_paid[0]->total_paid); ?></small>
                </div>
            </div>
        </div>
        <div class="col-lg-5 col-md-12 col-6 mb-4 shadow rounded">
            <div class="card">
                <div class="card-body">
                    ...
                    <span class="fw-semibold d-block mb-1 text-dark">Belum Terbayar</span>
                    <small class="text-success fw-semibold"><i class="bx bx-up-arrow-alt"></i> <?php echo e($total_unpaid[0]->total_unpaid); ?></small>
                </div>
            </div>
        </div>
        <div class="col-lg-5 col-md-12 col-6 mb-4 shadow rounded">
            <div class="card">
                <div class="card-body">
                    ...
                    <span class="fw-semibold d-block mb-1 text-dark">Meja</span>
                    <small class="text-success fw-semibold"><i class="bx bx-up-arrow-alt"></i> <?php echo e(20 - (int)$tables[0]->tables); ?></small>
                </div>
            </div>
        </div>
        <div class="col-lg-5 col-md-12 col-6 mb-4 shadow rounded">
            <div class="card">
                <div class="card-body">
                    ...
                    <span class="fw-semibold d-block mb-1 text-dark">Terjual</span>
                    <small class="text-success fw-semibold"><i class="bx bx-up-arrow-alt"></i> Rp <?php echo e(number_format($total_sales[0]->total_sales,0,',','.')); ?></small>
                </div>
            </div>
        </div>
    </div>
</div>
<?php /**PATH D:\ukk_resto\app_kasir_restoran\resources\views/dashboard/cashier.blade.php ENDPATH**/ ?>