...
unset($__errorArgs, $__bag); ?>" id="setting-input-1" name="username" value="<?php echo e(old('username')); ?>" required>
...
unset($__errorArgs, $__bag); ?>" id="setting-input-2" name="name" value="<?php echo e(old('name')); ?>" required>
...
unset($__errorArgs, $__bag); ?>" id="setting-input-3" name="email" value="<?php echo e(old('email')); ?>" required>
...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="mb-4">
                    ...
                    <select class="form-select <?php $__errorArgs = ['level_id'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" id="setting-input-4" name="level_id" required>
                        <option selected disabled hidden>- select role -</option>
                        <option value="2"  <?php if(old('level_id') == "2"): ?> <?php echo e('selected'); ?> <?php endif; ?> >Cashier</option>
                        <option value="3"  <?php if(old('level_id') == "3"): ?> <?php echo e('selected'); ?> <?php endif; ?> >Admin</option>
                    </select>
...
<?php echo $__env->make('layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\ukk_resto\app_kasir_restoran\resources\views/user/create.blade.php ENDPATH**/ ?>