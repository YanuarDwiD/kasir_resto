            ...
            <ul class="app-menu list-unstyled accordion">
                ...
                <li class="nav-item has-submenu">
                    ...
                    <div id="submenu-3" class="submenu submenu-3 <?php echo e(Request::is('user') ? 'collapse show' : (Request::is('user/create') ? 'collapse show' : 'collapse')); ?>" data-bs-parent="#menu-accordion">
                        <ul class="submenu-list list-unstyled">
                            <li class="submenu-item"><a class="submenu-link <?php echo e(Request::is('user') ? 'active' :  ''); ?>" href="/user">List Admin</a></li>
                            <li class="submenu-item"><a class="submenu-link <?php echo e(Request::is('user/create') ? 'active' :  ''); ?>" href="/user/create">Tambah Admin</a></li>
                        </ul>
                    </div>
                </li>
                <?php endif; ?>
                ...
                <li class="nav-item has-submenu">
                    ...
                    <div id="submenu-2" class="collapse submenu submenu-2 <?php echo e(Request::is('transaction') ? 'collapse show' : (Request::is('transaction/create') ? 'collapse show' : 'collapse')); ?>" data-bs-parent="#menu-accordion">
                        <ul class="submenu-list list-unstyled">
                            <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('manager')): ?>
                            <li class="submenu-item"><a class="submenu-link <?php echo e(Request::is('transaction') ? 'active' :  ''); ?>" href="/transaction">All Transaksi</a></li>
                            <?php endif; ?>
                            <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('cashier')): ?>
                            <li class="submenu-item"><a class="submenu-link <?php echo e(Request::is('transaction') ? 'active' :  ''); ?>" href="/transaction">All Transaksi</a></li>
                            <li class="submenu-item"><a class="submenu-link <?php echo e(Request::is('transaction/create') ? 'active' :  ''); ?>" href="/transaction/create">Pesanan</a></li>
                            <?php endif; ?>
                        </ul>
                    </div>
                </li>
...
</div><?php /**PATH D:\ukk_resto\app_kasir_restoran\resources\views/layouts/sidebar.blade.php ENDPATH**/ ?>