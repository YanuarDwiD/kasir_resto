                    ...
                    <div class="menu-content pe-4 ps-4 d-flex flex-wrap justify-content-between">
                        <?php $__currentLoopData = $foods; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $food): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <div class="menu-item-cart rounded shadow d-flex align-items-center justify-content-around"
                                data-id="<?php echo e($food->id); ?>" style="margin-bottom: 7%;">
                                <img class="img-fluid" src="<?php echo e(asset('storage/' . $food->picture)); ?>" alt=""
                                    srcset="" width="150">
                                <div class="d-flex justify-content-center flex-column">
                                    <div class="product">
                                        <h5 style="font-size: 16px; width: 100px;" class="text-break"><?php echo e($food->name); ?></h5>
                                        <h6 style="font-size: 13px;"><?php echo e(number_format($food->price, 0, ',', '.')); ?></h6>
                                    </div>
                ...
                <div class="tab-pane fade" id="drink">
                    <div class="menu-content pe-4 ps-4 d-flex flex-wrap justify-content-between">
                        <?php $__currentLoopData = $drinks; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $drink): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <div class="menu-item-cart rounded shadow d-flex align-items-center justify-content-around"
                                data-id="<?php echo e($drink->id); ?>" style="margin-bottom: 7%;">
                                <img class="img-fluid" src="<?php echo e(asset('storage/' . $drink->picture)); ?>" alt=""
                                    srcset="" width="150">
                                <div class="d-flex justify-content-center flex-column">
                                    <div class="product">
                                        <h5 style="font-size: 16px; width: 100px;" class="text-break"><?php echo e($drink->name); ?></h5>
                                        <h6 style="font-size: 13px;"><?php echo e(number_format($drink->price, 0, ',', '.')); ?></h6>
                                    </div>
                                    <div class="qty d-flex mt-3">
                                        <button class="border-0 rounded bg-transparent RemovetoCart"><i
                                                class="fa-solid fa-minus" style="font-size: 12px;"></i></button>
                ...
                <div class="tab-pane fade" id="dessert">
                    <div class="menu-content pe-4 ps-4 d-flex flex-wrap justify-content-between">
                        <?php $__currentLoopData = $desserts; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $dessert): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <div class="menu-item-cart rounded shadow d-flex align-items-center justify-content-around"
                                data-id="<?php echo e($dessert->id); ?>" style="margin-bottom: 7%;">
                                <img class="img-fluid" src="<?php echo e(asset('storage/' . $dessert->picture)); ?>" alt=""
                                    srcset="" width="150">
                                <div class="d-flex justify-content-center flex-column">
                                    <div class="product">
                                        <h5 style="font-size: 16px; width: 100px;" class="text-break"><?php echo e($dessert->name); ?></h5>
                                        <h6 style="font-size: 13px;"><?php echo e(number_format($dessert->price, 0, ',', '.')); ?></h6>
                                    </div>
                                    <div class="qty d-flex mt-3">
                                        <button class="border-0 rounded bg-transparent RemovetoCart"><i
                                                class="fa-solid fa-minus" style="font-size: 12px;"></i></button>
    ...
    <div class="col-md-4 h-100 p-0 d-flex flex-column">
        ...
        <div class="cart-body d-flex flex-column justify-content-between" style="height: 780px;">
            <div class="d-flex justify-content-between p-3 align-items-center">
                ...
                <h6 class="fw-semibold text-white me-2" style="font-size: 13px;"><?php echo e(now()->format('Y-m-d')); ?></h6>
            </div>
...
<?php echo $__env->make('layouts.order', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\ukk_resto\app_kasir_restoran\resources\views/transaction/create.blade.php ENDPATH**/ ?>