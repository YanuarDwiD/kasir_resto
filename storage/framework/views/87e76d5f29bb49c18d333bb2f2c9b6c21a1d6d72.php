...
<?php $__env->startSection('container'); ?>
    ...
    <div class="col-lg-8">
        <form action="/menu" method="post" enctype="multipart/form-data">
            <?php echo csrf_field(); ?>
            <div class="mb-3">
                <label for="name-product" class="form-label">Nama Makanan</label>
...
<?php echo $__env->make('layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\ukk_resto\app_kasir_restoran\resources\views/menu/add.blade.php ENDPATH**/ ?>